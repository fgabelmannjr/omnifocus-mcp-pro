 ...
 * - `candidates` array contains matching project IDs
 ...
 * - `candidates`: Array of matching project IDs when disambiguation required (optional)
 *
 * **Error Codes**:
...
export const ReviewBatchItemResultSchema = z.object({
  ...
  candidates: z
    .array(z.string())
    .optional()
    .describe('Matching project IDs when disambiguation required')
});
